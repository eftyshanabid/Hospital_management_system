            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="http://localhost/dbms_project/Otolaryngology.php?id=leo123" id="leo123" class="btn btn-primary">Make Appointment</a>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="http://localhost/dbms_project/Otolaryngology.php?id=sajid123" id="sajid123" class="btn btn-primary">Make Appointment</a>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="http://localhost/dbms_project/Otolaryngology.php?id=shipon123" id="shipon123" class="btn btn-primary">Make Appointment</a>
