            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="http://localhost/dbms_project/Otolaryngology.php?id=arefin123" id="arefin123" class="btn btn-primary">Make Appointment</a>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="http://localhost/dbms_project/Otolaryngology.php?id=arefin222" id="arefin222" class="btn btn-primary">Make Appointment</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="http://localhost/dbms_project/Otolaryngology.php?id=galib123" id="galib123" class="btn btn-primary">Make Appointment</a>
